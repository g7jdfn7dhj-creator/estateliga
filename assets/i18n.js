(function () {
  ...
  const dict = {
    en: {
      ...
      listings_empty_text: 'New homes for sale and rent in Constanța and Mamaia will appear here. Message us if you are looking for something specific.',
      ...
      about_exclusivity_body: 'Apartments, houses, and holiday homes: purchase, sale, and rental. Short stays or long-term living — we match the property to how you actually use it.',
    ...
    ro: {
      ...
      listings_empty_text: 'Locuințele de vânzare și închiriere din Constanța și Mamaia vor apărea aici. Scrieți-ne dacă căutați ceva anume.',
      about_heritage: 'LOCAL',
      ...
      about_exclusivity_body: 'Apartamente, case și locuințe de vacanță: cumpărare, vânzare și închiriere. Ședere scurtă sau pe termen lung — potrivim proprietatea cu felul în care o folosiți.',
    ...
    de: {
      ...
      listings_empty_text: 'Wohnungen und Häuser zum Kauf und zur Miete in Constanța und Mamaia erscheinen hier. Schreiben Sie uns, wenn Sie etwas Bestimmtes suchen.',
      ...
      about_exclusivity_body: 'Wohnungen, Häuser und Ferienwohnungen: Kauf, Verkauf und Vermietung. Kurz oder langfristig — passend dazu, wie Sie die Immobilie nutzen.',
    ...
    ru: {
      ...
      listings_empty_text: 'Здесь появятся квартиры и дома на продажу и в аренду в Констанце и Мамае. Напишите, если ищете что-то конкретное.',
      ...
      about_exclusivity_body: 'Квартиры, дома и жильё у моря: покупка, продажа и аренда. Короткий срок или долгий — подбираем под то, как вы реально будете жить.',
